...
def main():
    ...
    MANUAL_DICT = {
        ...
        'Alvocidib': 'CN1CC[C@@H]([C@@H](C1)O)C2=C(C=C(C3=C2OC(=CC3=O)C4=CC=CC=C4Cl)O)O',
        ...
        'GDC-0879': 'C1C/C(=N\\O)/C2=C1C=C(C=C2)C3=CN(N=C3C4=CC=NC=C4)CCO',
        'Sgx-523': 'CN1C=C(C=N1)C2=NN3C(=NN=C3SC4=CC5=C(C=C4)N=CC=C5)C=C2'
    }
